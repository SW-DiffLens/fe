...
export default function Tooltip({
  ...
  return (
    <div className="group relative flex items-center justify-center">
      {children}
      <div
        className={`invisible absolute opacity-0 transition-all duration-200 group-hover:visible group-hover:opacity-100 ${positionClasses[position]} rounded-lg bg-gray-900 px-3 py-2 text-center text-caption text-white shadow-lg`}
        style={{ width }}
      >
        {content}
